...
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
| wchar       | 2      | 符号なし16ビット整数         | :ref:`文字(列) <about_dll_string_param>` | ✅   | ✅     |                                                         |
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
| byte        | 1      | 符号なし8ビット整数          | 数値                                     | ✅   | ✅     |                                                         |
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
| char        | 1      | 符号なし8ビット整数          | :ref:`文字(列) <about_dll_string_param>` | ✅   | ✅     |                                                         |
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
| boolean     | 1      | 符号なし8ビット整数          | 真偽値                                   | ✅   | ✅     |                                                         |
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
| longlong    | 8      | 符号あり64ビット整数         | 数値                                     | ✅   | ✅     |                                                         |
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
| string      | 可変   | ANSI文字列のポインタ         | :ref:`文字列 <about_dll_string_param>`   | ✅   |        |                                                         |
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
| pchar       | 可変   | ANSI文字列のポインタ         | :ref:`文字列 <about_dll_string_param>`   | ✅   |        |                                                         |
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
| wstring     | 可変   | ワイド文字列のポインタ       | :ref:`文字列 <about_dll_string_param>`   | ✅   |        |                                                         |
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
| pwchar      | 可変   | ワイド文字列のポインタ       | :ref:`文字列 <about_dll_string_param>`   | ✅   |        |                                                         |
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
...
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
| struct      | 可変   | ユーザー定義構造体のポインタ | 構造体                                   | ✅   |        |                                                         |
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
| callback    | 可変   | コールバック関数のポインタ   | ユーザー定義関数                         | ✅   |        | :ref:`コールバック関数の型定義 <about_callback>` を行う |
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
| safearray   | 可変   | SAFEARRAYのポインタ          | 配列                                     | ✅   |        |                                                         |
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
| void        | 1      | 型がないことを示す           |                                          |      | ✅     |                                                         |
+-------------+--------+------------------------------+------------------------------------------+------+--------+---------------------------------------------------------+
...
| メンバが配列の場合は ``buffer: byte[260]`` のようにメンバ名、型名に加えてサイズを示す数値を ``[]`` 内に書きます
| 型名には以下が利用可能です
